...
from self_correct_robot.config import Config, config_factory
...
def example_dataset_path():
    ...
    """
    dataset_folder = os.path.join(self_correct_robot.__path__[0], "../tests/assets/")
...
def temp_model_dir_path():
    ...
    """
    return os.path.join(self_correct_robot.__path__[0], "../tests/tmp_model_dir")
...
def temp_dataset_path():
    ...
    """
    return os.path.join(self_correct_robot.__path__[0], "../tests/", "tmp.hdf5")
...
def temp_video_path():
    ...
    """
    return os.path.join(self_correct_robot.__path__[0], "../tests/", "tmp.mp4")
...
def get_base_config(algo_name):
    ...
    base_config_path = os.path.join(self_correct_robot.__path__[0], "exps/templates/{}.json".format(algo_name))
