...
from self_correct_robot.algo import RolloutPolicy
...
def get_env_metadata_from_dataset(dataset_path, ds_format="self_correct_robot"):
    """
    ...
    if ds_format == "self_correct_robot":
...
def get_shape_metadata_from_dataset(dataset_path, action_keys, all_obs_keys=None, ds_format="self_correct_robot", verbose=False):
    """
