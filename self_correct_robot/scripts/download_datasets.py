...
datasets will be stored at self_correct_robot/datasets, unless the @download_dir
...
if __name__ == "__main__":
    ...
    if default_base_dir is None:
        default_base_dir = os.path.join(self_correct_robot.__path__[0], "../datasets")
                        ...
                        if hdf5_type in download_hdf5_types:
                            ...
                            if url is None:
                                print(
                                    ...
                                    + " Create this dataset locally by running the appropriate command from self_correct_robot/scripts/extract_obs_from_raw_datasets.sh."
                                )
                                continue
                            if args.dry_run:
