...
Example usage:
    ...
    # downloads to default path at self_correct_robot/datasets/d4rl
...
from self_correct_robot.utils.log_utils import custom_tqdm
...
if __name__ == "__main__":
    ...
    if base_folder is None:
        base_folder = os.path.join(self_correct_robot.__path__[0], "../datasets")
