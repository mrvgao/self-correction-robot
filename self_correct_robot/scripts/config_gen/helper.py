...
# from self_correct_robot.scripts.config_gen.dataset_registry import get_ds_cfg

base_path = os.path.abspath(os.path.join(os.path.dirname(self_correct_robot.__file__), os.pardir))
