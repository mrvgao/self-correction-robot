"""
Set of global variables shared across self_correct_robot
"""
...
try:
    from self_correct_robot.macros_private import *
except ImportError:
    ...
    log_warning(
        ...
        "\nTo setup, run: python {}/scripts/setup_macros.py".format(self_correct_robot.__path__[0])
    )
