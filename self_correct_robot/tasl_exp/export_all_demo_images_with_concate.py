...
def extract_and_export_image(demo_dataset, task_name):
    ...
    dir_name_left = f'/home/ubuntu/robocasa-statics/export-images-from-demo-3k/{task_name}/left_images/'
    dir_name_right = f'/home/ubuntu/robocasa-statics/export-images-from-demo-3k/{task_name}/right_images/'
    dir_name_hand = f'/home/ubuntu/robocasa-statics/export-images-from-demo-3k/{task_name}/hand_images/'
    dir_name_task_emb = f'/home/ubuntu/robocasa-statics/export-images-from-demo-3k/{task_name}/task_emb/'
